...
The engineering skills use five canonical triage roles. Local issue files record the
corresponding value in their `Status:` line.
...
When a skill names a canonical role, use the matching local label above.
